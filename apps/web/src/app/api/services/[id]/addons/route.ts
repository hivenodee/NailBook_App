...
import { createAddOnSchema } from "@nailbook/shared";

export const dynamic = "force-dynamic";

type Params = { params: Promise<{ id: string }> };

// POST /api/services/:id/addons — create add-on for service
export async function POST(request: NextRequest, { params }: Params) {
  ...
  const result = await parseBody(request, createAddOnSchema);
